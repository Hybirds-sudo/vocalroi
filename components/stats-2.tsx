...
export default function Stats() {
    return (
        <section id="results" className="bg-background @container py-24">
            <div className="mx-auto max-w-2xl px-6">
                <div className="space-y-4">
                    <h2 className="text-balance font-serif text-4xl font-medium">Results That Move the Needle</h2>
                    <p className="text-muted-foreground text-balance">Our clients see real growth — more leads, faster response times, and higher conversion rates across the board.</p>
                </div>
                <div className="@xl:grid-cols-3 mt-12 grid grid-cols-2 gap-6 text-sm">
                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">3x</span> more qualified leads on average.
                        </p>
                    </div>

                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">24/7</span> AI-powered lead response.
                        </p>
                    </div>

                    <div className="border-y py-6">
                        <p className="text-muted-foreground text-xl">
                            <span className="text-foreground font-medium">40%</span> less time spent on manual follow-up.
                        </p>
                    </div>
                </div>
            </div>
