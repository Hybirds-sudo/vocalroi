    ...
    return (
        <section id="services" className="bg-background @container py-24">
            <div className="mx-auto max-w-2xl px-6">
                <div>
                    <h2 className="text-balance font-serif text-4xl font-medium">AI Systems That Bring You Customers</h2>
                    <p className="text-muted-foreground mt-4 text-balance">We design and deploy automation that attracts leads, responds instantly, and converts more of them into paying customers.</p>
                </div>
                <div className="@xl:grid-cols-2 mt-12 grid gap-3 *:p-6">
                    <Card
                        ...
                        <div className="space-y-2">
                            <h3 className="text-foreground font-medium">AI Lead Capture</h3>
                            <p className="text-muted-foreground text-sm">Capture and qualify leads 24/7 from your website, ads, and phone lines — without missing a single inquiry.</p>
                        </div>
                        <div
                            aria-hidden
                    ...
                    <Card
                        ...
                        <div className="space-y-2">
                            <h3 className="text-foreground font-medium">Instant Follow-Up</h3>
                            <p className="text-muted-foreground text-sm">Respond to every new lead in seconds with personalized emails, texts, and voice outreach.</p>
                        </div>
                        <div
                            aria-hidden
                    ...
                    <Card
                        ...
                        className="row-span-2 grid grid-rows-subgrid overflow-hidden">
                        <div className="space-y-2">
                            <h3 className="text-foreground font-medium">Workflow Automation</h3>
                            <p className="text-muted-foreground mt-2 text-sm">Replace repetitive tasks with smart workflows so your team spends time closing deals, not chasing paperwork.</p>
                        </div>
                        <div
                            aria-hidden
                    ...
                    <Card
                        ...
                        className="row-span-2 grid grid-rows-subgrid">
                        <div className="space-y-2">
                            <h3 className="font-medium">Built to Scale</h3>
                            <p className="text-muted-foreground text-sm">Growth systems that expand with your business — from your first 10 leads to thousands per month.</p>
                        </div>
