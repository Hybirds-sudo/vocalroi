...
const links = [
    ...
    { label: 'Contact', href: 'https://calendly.com/odiljonovbekzod86/meeting-1-1' },
]
        ...
        <footer className="bg-background @container border-t py-12">
            <div className="mx-auto max-w-2xl px-6">
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-muted-foreground mt-8 text-sm">&copy; {2026} VocalROI. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
